...
{
    public Task<IResult> HandleResponseAsync(ClientId clientId, string deploymentId, string? contextId, DeepLinkResponse response, CancellationToken cancellationToken = default) =>
