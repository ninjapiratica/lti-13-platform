...
namespace NP.Lti13Platform.NameRoleProvisioningServices.Populators
{
    ...
    public class ServiceEndpointsPopulator(LinkGenerator linkGenerator, ILti13NameRoleProvisioningService nameRoleProvisioningService) : Populator<IServiceEndpoints>
    {
