...
/// <summary>
/// Provides functionality for dynamically generating types at runtime.
/// </summary>
public static partial class TypeGenerator
{
    ...
    /// <summary>
    /// Generates a regex that matches non-alphanumeric characters.
    /// </summary>
    /// <returns>A regex that matches non-alphanumeric characters.</returns>
    [GeneratedRegex("[^a-zA-Z0-9]")]
    private static partial Regex LettersAndNumbersRegex();

    /// <summary>
    /// Creates a new type that implements the specified interfaces and optionally inherits from the specified base type.
    /// </summary>
    /// <param name="typeName">The name of the type to create.</param>
    /// <param name="interfaces">The interfaces to implement.</param>
    /// <param name="baseType">The base type to inherit from, or null if the type should not inherit from a specific base type.</param>
