...
public abstract class LtiMessageResult
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of the LTI message to include in the result. Must implement <see cref="ILtiMessage"/>.</typeparam>
    ...
    public static LtiMessageResult Success<T>(T ltiMessage) where T : ILtiMessage
