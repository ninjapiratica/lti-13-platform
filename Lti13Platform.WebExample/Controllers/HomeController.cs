        ...
        public async Task<IResult> Index()
        {
            ...
            return Results.Ok(new
            {
                ...
                resourceLinkUrls = DataService.ResourceLinks
                    .Select(resourceLink => service.GetResourceLinkInitiationUrl(tool!, deployment!.Id, context!.Id, resourceLink, userId, launchPresentation: new LaunchPresentationOverride { DocumentTarget = documentTarget, Height = height, Width = width, Locale = locale, ReturnUrl = "" }))
            });
        }
    }
}
