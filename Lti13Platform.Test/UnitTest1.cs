...
namespace NP.Lti13Platform.Test
{
    public class UnitTest1
    {
        ...
        public void Test2()
        {
            ...
            var paramss = rsaProvider.ExportParameters(false);
            var x = new RsaSecurityKey(paramss)
            {
                KeyId = "asdf"
            };

            var y = JsonWebKeyConverter.ConvertFromSecurityKey(x);

            var a = JsonSerializer.Serialize(y);
        }
