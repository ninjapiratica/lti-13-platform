namespace NP.Lti13Platform.AssignmentGradeServices
{
    public class Lti13PlatformAGSEndpointsConfig
    {
        ...
        public string AssignmentAndGradeServiceLineItemsUrl { get; set; } = "/lti13/{deploymentId}/{contextId}/lineItems";
        ...
        public string AssignmentAndGradeServiceLineItemBaseUrl { get; set; } = "/lti13/{deploymentId}/{contextId}/lineItems/{lineItemId}";
    }
}
